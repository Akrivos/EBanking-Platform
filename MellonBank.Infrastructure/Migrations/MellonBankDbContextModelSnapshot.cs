...
namespace MellonBank.Infrastructure.Migrations
{
    ...
    partial class MellonBankDbContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("MellonBank.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.HasOne("MellonBank.Domain.Entities.BankAccount", "FromAccount")
                        .WithMany()
                        .HasForeignKey("FromAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MellonBank.Domain.Entities.BankAccount", "ToAccount")
                        .WithMany()
